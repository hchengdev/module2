...
public class Menu {
    ...
    public static void addTelephone() {
        ...
        System.out.println("║>[4]. Thêm mới điện thoại xách tay                          ║");
        System.out.println("║>[5]. Thoát                                                 ║");
        System.out.println("║                                                            ║");
        System.out.println("╚============================================================╝");
        System.out.println("Mời nhập lựa chọn:");
    ...
    public static void removeTelephoneM() {
        System.out.println("╔============================================================╗");
        System.out.println("║              ▂ ▃ ▅ ▆ █ REMOVE TELEPHONE █ ▆ ▅ ▃ ▂          ║");
        System.out.println("╠============================================================╣");
        System.out.println("║>[1]. Xoá điện thoại chính hãng                             ║");
        System.out.println("║>[4]. Xoá mới điện thoại xách tay                           ║");
        System.out.println("║>[5]. Thoát                                                 ║");
        System.out.println("║                                                            ║");
        System.out.println("╚============================================================╝");
        System.out.println("Mời nhập lựa chọn:");
    ...
    public static void showListMenu() {
        System.out.println("╔============================================================╗");
        System.out.println("║            ▂ ▃ ▅ ▆ █ SHOW LIST TELEPHONE █ ▆ ▅ ▃ ▂         ║");
        System.out.println("╠============================================================╣");
        System.out.println("║>[1]. Danh sách điện thoại chính hãng                       ║");
        System.out.println("║>[4]. Danh sách điện thoại xách tay                         ║");
        System.out.println("║>[5]. Thoát                                                 ║");
        System.out.println("║                                                            ║");
        System.out.println("╚============================================================╝");
        System.out.println("Mời nhập lựa chọn:");
    ...
    public static void searchMenu() {
        System.out.println("╔============================================================╗");
        System.out.println("║            ▂ ▃ ▅ ▆ █ SERCH TELEPHONE █ ▆ ▅ ▃ ▂             ║");
        System.out.println("╠============================================================╣");
        System.out.println("║>[1]. Tìm kiếm điện thoại chính hãng                        ║");
        System.out.println("║>[4]. Tìm kiếm điện thoại xách tay                          ║");
        System.out.println("║>[5]. Thoát                                                 ║");
        System.out.println("║                                                            ║");
        System.out.println("╚============================================================╝");
        System.out.println("Mời nhập lựa chọn:");
